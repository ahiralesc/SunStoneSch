function H = absval(sequence, isplot, moment)
    %% ABSVAL
    % Estimate the hurst parameter of a given sequence with ABSOLUTE MOMENT method.
    %
    % Inputs:
    ...
    %  Author       : Chu Chen, Adan Hirales Carbajal
    %  Version      : 1.1,  03/10/2008, 9/29/2014
    %  Email        : chen-chu@163.com, ahiralesc@gmail.com
    %
