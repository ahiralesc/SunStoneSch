    ...
    for i = 1 : total_number_of_system_criterion_list
        ...
        if number_of_directories_with_data > 0
            ...
            if (get(handles.checkbox_g_percent,'Value') == get(handles.checkbox_g_percent,'Max'))
                total_number_of_graphics = build_percent_results(handles, total_number_of_graphics, number_of_experiments, list_of_directories_with_data, system_criterion_list(i), node_flag, allocation_flag, sub_legend);
            end
...
function total_number_of_graphics = build_mean_std_results(handles, total_number_of_graphics, number_of_experiments, list_of_directories_with_data, criterion_to_graphic, node_flag, allocation_flag, sub_legend)
            ...
            for j = 1 : number_of_columns_of_data
                ...
                posicion_y(j) = bar_first_position + (j - 1) * bar_separation;
            end
            ...
            hold on;
            %  Graphic data
            graphic_bar = plot(matrix_of_mean(1,:),posicion_y , 'o');
...
function total_number_of_graphics = build_percent_results(handles, total_number_of_graphics, number_of_experiments, list_of_directories_with_data, criterion_to_graphic, node_flag, allocation_flag, sub_legend)
            ...
            for j = 1 : number_of_columns_of_data
                matrix_of_percent (1, j) = matrix_of_mean(1, j) / opt_mean_value * 100;
            end
